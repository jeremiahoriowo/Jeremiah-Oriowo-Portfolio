// SHOWING THE MENU (Variables)
const navMenu = document.getElementById('nav-menu'),
      navToggle = document.getElementById('nav-toggle'),
      navClose = document.getElementById('nav-close'),
      NavMenu = document.querySelector('.nav__menu')
// SHOW MENU
    // if validation to show menu
if(navToggle){
...
const modalViews = document.querySelectorAll('.services__modal'),
    ...
    // modalViews[2].classList.add('active-modal')
    // modalViews[1].classList.add('active-modal')
    // modalViews[0].classList.add('active-modal')
    for (let i = 0; i < modalViews.length; i++) {
        const element = modalViews[i];
...
function scrollHeader() {
    ...
    // When the scroll is greater than 800 viewport height, add the scroll-header class to the header tag
